...
| Duplicate rows     |                    Not specified |       Not specified |
| Memory usage       |                    Not specified |       Not specified |
| Class distribution |              See target analysis | See target analysis |

*The final dataset is divided into **202,636 training records** and **50,655 testing records**, giving a total of **253,291 records**. The source report explicitly provides these train/test sizes.

> **Note:** Values marked as "Not specified" should be replaced with the actual values generated by the preprocessing pipeline if those metrics are calculated in the notebook.
